...
import { useSavedAccounts, useDeleteSavedAccount } from "@/lib/hooks/use-saved-accounts";
...
export function SavedAccountsManager() {
    ...
    const handleDelete = (id: string, bankName: string) => {
        if (!confirm(`Are you sure you want to delete the account at ${bankName}?`)) {
            return;
        }
        ...
        <div className="space-y-4">
            ...
            {isLoading ? (
                ...
                <div className="text-center py-12 bg-zinc-900/30 border border-zinc-800 rounded-lg">
                    ...
                    <h3 className="text-lg font-medium text-white mb-1">No saved accounts</h3>
