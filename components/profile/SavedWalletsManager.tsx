...
import { useSavedWallets, useDeleteWallet } from "@/lib/hooks/use-saved-wallets";
...
export function SavedWalletsManager() {
    ...
    const handleDelete = (id: string, address: string) => {
        if (!confirm(`Are you sure you want to delete wallet ${address.slice(0, 6)}...${address.slice(-4)}?`)) {
            return;
        }
        ...
        <div className="space-y-4">
            ...
            {isLoading ? (
                ...
                <div className="text-center py-12 bg-zinc-900/30 border border-zinc-800 rounded-lg">
                    ...
                    <h3 className="text-lg font-medium text-white mb-1">No saved wallets</h3>
