...
export default function DirectorsForm({ onNext, onBack }: DirectorsFormProps) {
    ...
    const currentFieldRef = useRef<keyof DirectorFormValues | null>(null);
    ...
    const handleUploadClick = (field: keyof DirectorFormValues) => {
    ...
    const removeUpload = (field: keyof DirectorFormValues) => {
        setUploads(prev => {
    ...
    const onSubmit = async (data: DirectorFormValues) => {
        ...
        try {
            ...
            await merchantApi.submitDirector({
                ...data,
                merchantId: user.id,
            });
            ...
            toast({
                title: "Success",
                description: "Director information saved successfully",
                variant: "success",
            });
            onNext();
        } catch (error) {
    ...
    const UploadField = ({ field, label }: { field: keyof DirectorFormValues, label: string }) => (
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    <Input id="role" {...register("role")} placeholder="e.g. Chairman, CEO" className="bg-black/50 border-white/10 h-11" />
